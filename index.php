            ...
            <div class="owl-carousel main-carousel position-relative">
                <?php foreach ($newsRows as $row) : ?>
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                        <img class="img-fluid h-100" src="./img/<?php echo $row['newsimage']; ?>" style="object-fit: cover; width: 800px; height: 500px;">
                        <div class="overlay">
                            <div class="mb-2">
                                <?php if (isset($row['category_name'])) : ?>
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="category.php?category_id=<?php echo $row['category_name']; ?>"><?php echo $row['category_name']; ?></a>
                                <?php endif; ?>
                                <a class="text-white" href=""><?php echo formatNewsDate($row['newsdate']); ?></a>
                            </div>
                            <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="single.php?id=<?php echo $row['news_id']; ?>"><?php echo $row['title']; ?></a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
                ...
                <?php foreach ($newsRows as $row) : ?>
                    <div class="col-md-6 px-0">
                        <div class="position-relative overflow-hidden" style="height: 250px;">
                            <img class="img-fluid w-100 h-100" src="./img/<?php echo $row['newsimage']; ?>" style="object-fit: cover; width:700px; height: 435px;">
                            <div class="overlay">
                                <div class="mb-2">
                                    <?php if (isset($row['category_name'])) : ?>
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="category.php?category_id=<?php echo $row['category_name']; ?>"><?php echo $row['category_name']; ?></a>
                                ...
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="single.php?id=<?php echo $row['news_id']; ?>"><?php echo $row['title']; ?></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center ml-3" style="width: calc(100% - 170px); padding-right: 90px;">
                            <?php foreach ($newsRows as $row) { ?>
                                <div class="text-truncate"><a class="text-white text-uppercase font-weight-semi-bold" href="single.php?id={$row['news_id']}"><?php echo $row['title']; ?></a></div>
                            <?php } ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid pt-5 mb-3">
        <div class="container">
            ...
            <div class="position-relative overflow-hidden" style="height: 300px;">
                    <img class="img-fluid h-100" src="./img/<?php echo $row['newsimage']; ?>" style="object-fit: cover; width:700px; height:435px;">
                    <div class="overlay">
                        <div class="mb-2">
                        <?php if (isset($row['category_name'])) { ?>
                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                href="category.php?category_id=<?php echo $row['category_name']; ?>"><?php echo $row['category_name']; ?></a>
                        <?php } ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            ...
                            <a class="btn btn-primary float-right" href="category.php">View More</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                ...
                                <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                    ...
                                    <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="single.php?id=<?php echo $row['news_id']; ?>"><?php echo $row['title']; ?>...</a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
...
<div class="col-lg-12">
    <div class="row news-lg mx-0 mb-3">
        ...
        <?php $selectedNews = $newsRows[1]; ?>
            <img class="img-fluid h-100" src="./img/<?php echo $selectedNews['newsimage']; ?>" style="object-fit: cover; width: 100%; height: 100vh;">
        </div>
        <div class="col-md-6 d-flex flex-column border bg-white h-100 px-0 align-items-center">
            <div class="mt-auto p-4">
                <div class="mb-2">
                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="category.php?category_id={$category['category_id']}"><?php echo $selectedNews['category_name']; ?></a>
                    <a class="text-body" href=""><small><?php echo formatNewsDate($selectedNews['newsdate']); ?></small></a>
                </div>
                <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="single.php?id=<?php echo $row['news_id']; ?>"><?php echo $selectedNews['title']; ?>...</a>
