...
if(isset($_GET['id'])) {
    ...
    // Prepare SQL statement to fetch news data based on ID
    $newsQuery = "SELECT * FROM news WHERE news_id = :id";
    $newsStmt = $conn->prepare($newsQuery);
    $newsStmt->bindParam(':id', $newsId);
    $newsStmt->execute();
    $newsRow = $newsStmt->fetch();

   
} else {
    // If news ID is not set in the URL, display error message or redirect to another page
...
<body>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center bg-white border border-left-0"
                            ...
                            <div class="text-truncate"><a class="text-secondary text-uppercase font-weight-semi-bold" href=""><?php echo $row['title']; ?></a></div>
                            <?php } ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="position-relative mb-3">
        <img class="img-fluid w-100"
            src="./img/<?php echo sanitizeInput($newsRow['newsimage']); ?>"
            style="object-fit: cover; width: 700px; height: 435px;">
        <div class="bg-white border border-top-0 p-4">
            <div class="mb-3">
                <?php if (isset($newsRow['category_name'])) { ?>
                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                    href=""><?php echo ($newsRow['category_name']); ?></a>
                <?php } ?>
                <a class="text-body" href=""><?php echo formatNewsDate($newsRow['newsdate']); ?></a>
            </div>
            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold"
                href="single.php?id=<?php echo $newsRow['news_id']; ?>"><?php echo ($newsRow['title']); ?></h1>
            <p><?php echo ($newsRow['content']); ?></p>

        </div>
        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
            <div class="d-flex align-items-center">
                <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
                <span><?php echo ($newsRow['author']); ?></span>
            </div>
            <div class="d-flex align-items-center">
                        ...
                        <?php foreach ($newsRows as $row) { ?>
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                ...
                                <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href=""><?php echo $row['category_name']; ?></a>
                                        <a class="text-body" href=""><small><?php echo formatNewsDate($row['newsdate']); ?></small></a>
                                    </div>
                                    <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="single.php?id=<?php echo $newsRow['news_id']; ?>"><?php echo $row['title']; ?></a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
   ...
   <div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
    ...
    <?php foreach ($newsRows as $newsItem): ?>
        <div class="mb-3">
            <div class="mb-2">
                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href=""><?php echo $newsItem['category_name']; ?></a>
    ...
    <?php if (!empty($newsRows)): ?>
        <div class="mb-3">
            <div class="mb-2">
                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href=""><?php echo $newsRows[count($newsRows) - 1]['category_name']; ?></a>
    ...
    <?php endif; ?>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <?php foreach ($categories as $category): ?>
                    ...
                    <a href="" class="btn btn-sm btn-secondary m-1" value='<?php echo $category["category_id"]; ?>'><?php echo $category["category_name"]; ?></a>
                    <?php endforeach; ?>
