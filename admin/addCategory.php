...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$category_name = $_POST['category_name']; // Get category name from form
    
    // Check if category name is not empty
    if (!empty($category_name)) {
        // Prepare and execute query to insert category into 'categories' table
        $categoryQuery = "INSERT INTO categories (category_name) VALUES (?)";
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="post" action="addcategory.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<a class="btn btn-primary" href="categories.php">Cancel</a>
												<!--<button class="btn btn-primary" type="button" href="categories.php">Cancel</button>-->
