...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO users (fullname, username, email, password, active, register_date) VALUES (?, ?, ?, ?, ? ,NOW())";
    $stmt = $conn->prepare($query);
    $stmt->execute([$fullname, $username, $email, $password, $active]);
...
// Check if success parameter is set and equals 1, then display success message
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form method="post" action="adduser.php" data-parsley-validate class="form-horizontal form-label-left">
