...
if(isset($_GET['id'])) {
    ...
    $category_name = $categorystmt->fetch(PDO::FETCH_ASSOC);
...
if($category_name !==null){
	if(isset($_POST['editcategory'])) {
		...
		if(!empty($newcategory_name)){
			$editcategory_query = "UPDATE categories SET category_name = ? WHERE category_id = ?";
			$stmt = $conn->prepare($editcategory_query);
			$stmt->execute([$newcategory_name, $id]);
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required" class="form-control " name="category_name" value="<?php echo $category_name['category_name']; ?>">
											</div>
										</div>
