...
if(isset($_GET['id'])) {
  ...
  $checkQuery = "SELECT * FROM news WHERE category_id = :category_id";
  ...
  if(!$result) {
      ...
      $_SESSION['success_message'] = "The category has been successfully deleted.";
  } else {
     $_SESSION['error_message'] = "This category cannot be deleted because it contains news.";
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Categories <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="addCategory.php" name="addcategory">Add Category</a></li>
                    <li><a href="categories.php" name="categories">Categories List</a></li>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                       foreach ($categories as $row){
                        ...
                        <td><a href='Categories.php?id={$row['category_id']}' onclick=\"return confirm('Are you sure you want to delete this category?')\"><img src='./images/delete.png' alt='Delete'></a></td>
